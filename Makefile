...
VPATH		:=		src src/lexer src/command_table src/handle_process		\
					src/init src/builtins src/exec src/expander src/signals	\
...
SRC_PROCESS	:=		stop_process.c set_error_code.c stop_loop.c				\
					if_null_stop_process.c
SRC_INIT	:=		init.c init_env.c input_check.c get_input.c
...
SOURCE 		:=		$(SRC_MAIN) $(SRC_LEXER) $(SRC_CMD_TAB) $(SRC_PROCESS)	\
